...
- **Push Notifications** — Daily quest reminders via browser push, plus an opt-in "due today" reminder that lists the tasks actually due today (silent on empty days — no "all clear" pings). Works via Web Push, ntfy.sh, Pushover, Telegram, or Email.
