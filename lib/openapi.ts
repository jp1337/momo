          ...
          content: {
            "application/json": {
              schema: {
                type: "object",
                properties: {
                  notificationTime: { type: "string", pattern: "^\\d{2}:\\d{2}$", description: "Shared time for daily-quest and streak reminders (HH:MM, 24h)." },
                  ...
                  overdueReminderEnabled: { type: "boolean", description: "Whether to send overdue-task reminders." },
                  morningBriefingEnabled: { type: "boolean", description: "Whether to send a daily morning briefing." },
                  morningBriefingTime: { type: "string", pattern: "^\\d{2}:\\d{2}$", description: "Time for the morning briefing (HH:MM, 24h). Default: 08:00." },
                  dueTodayReminderTime: { type: "string", pattern: "^\\d{2}:\\d{2}$", description: "Independent delivery time for the due-today reminder (HH:MM, 24h). Default: 08:00." },
                  recurringDueReminderTime: { type: "string", pattern: "^\\d{2}:\\d{2}$", description: "Independent delivery time for recurring-due reminders (HH:MM, 24h). Default: 08:00." },
                  overdueReminderTime: { type: "string", pattern: "^\\d{2}:\\d{2}$", description: "Independent delivery time for the overdue reminder (HH:MM, 24h). Default: 08:00." },
                  weeklyReviewTime: { type: "string", pattern: "^\\d{2}:\\d{2}$", description: "Delivery time for the Sunday weekly review notification (HH:MM, 24h). Default: 18:00." },
                },
              },
            },
          },
